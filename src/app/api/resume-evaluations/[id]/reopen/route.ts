...
import { parseResumeEvaluationReopenPayload } from "@/utils/resumeEvaluationValidation";
...
export async function POST(
  ...
  try {
    ...
    const input = parseResumeEvaluationReopenPayload(body);
    const evaluation = await resumeEvaluationResultService.reopenEvaluation(id, input);
